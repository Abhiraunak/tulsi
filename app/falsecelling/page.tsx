    ...
    return (
        <>
            ...
            <main className="max-w-screen h-1/4 mb-10">
                <Header
                    imageUrl={"/Falsecelling/celling3.jpg"}
            ...
            <section className="container relative max-w-screen-xl mx-auto">
                ...
                <div className="flex items-center justify-center mx-8 md:mx-0">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        <ProductDescription imageUrl={"/Falsecelling/celling1.png"} description={"Living Rooms"} />
                        <ProductDescription imageUrl={"/Falsecelling/celling3.jpg"} description={"Gallery"} />
                        <ProductDescription imageUrl={"/Falsecelling/celling4.jpg"} description={"Empty room"} />
                    </div>
                </div>
            </section>
            <div className="container relative max-w-screen-2xl mx-auto pt-5 md:pt-20 pb-10">
                <ProductBetween
                    imageUrl={"/Falsecelling/celling5.jpg"}
