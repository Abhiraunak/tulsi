...
export default function ProductBetween({ imageUrl, headingText, bottomText, buttonText, to }: ProductBetweenProps) {
    return (
        <div className="w-full overflow-x-hidden"> {/* Added wrapper container */}
            <div
                className="w-[120%] md:w-full h-[15rem] md:h-[20rem] bg-cover bg-center relative flex items-center justify-center -ml-[10%] md:ml-0" // Added negative margin
                style={{ backgroundImage: `url(${imageUrl})` }}
                aria-label="Product background"
            >
                <div className="flex flex-col items-center">
                    <h1 className="text-3xl font-bold text-white leading-3 mb-5">{headingText}</h1>
